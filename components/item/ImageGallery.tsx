  ...
  return (
    <div className="flex min-w-0 flex-col gap-3">
      <div className="group relative aspect-square overflow-hidden rounded-2xl bg-gray-100">
        ...
        {showControls && (
          <span className="absolute bottom-3 right-3 rounded-lg bg-gray-900/60 px-2.5 py-1 text-xs font-medium tabular-nums text-white backdrop-blur-sm">
            {active + 1} / {count}
          </span>
        )}
      </div>
            ...
            return (
              <button
                ...
                className={`relative h-16 w-16 shrink-0 overflow-hidden rounded-xl bg-gray-100 transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-green-600 ${
                  isActive
                    ? "opacity-100 ring-2 ring-green-600 ring-offset-2"
